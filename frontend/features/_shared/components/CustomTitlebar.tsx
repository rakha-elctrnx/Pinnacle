...
export function CustomTitlebar({ title }: CustomTitlebarProps) {
  ...
  return (
    <div
      ...
      className="relative flex h-8 shrink-0 items-center border-b border-outline-variant px-3"
    >
      ...
      <span className="pointer-events-none select-none text-xs font-medium text-on-surface/80 absolute inset-0 flex items-center justify-center">
        {title}
      </span>
    </div>
  )
